...
### Packages with vendorHash (Go)

duckgo, ghalint, ghatm, gh-dep, gh-grep, gh-triage, ghq, git-wt, gitlab-ci-verify, octocov, pinact, roots, slack-reminder, disable-checkout-persist-credentials

### Packages with vendorHash = null (skip)

lazygit, vim-startuptime

### Packages with cargoHash (Rust)

gitlab-ci-ls

### Packages without dependency hashes (skip)

cc-sdd, ccusage, claude-code, sort-package-json, firge, firge-nerd, ibm-plex-sans-jp, veridex
