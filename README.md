...
|[claude-code](https://github.com/anthropics/claude-code)|v2.0.50|Agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster.|
...
|[gitlab-ci-verify](https://github.com/timo-reymann/gitlab-ci-verify)|v2.4.4|Validate and lint your gitlab ci files using ShellCheck, the Gitlab API, curated checks or even build your own checks .|
...
|[pinact](https://github.com/suzuki-shunsuke/pinact)|v3.4.4|pinact is a CLI to edit GitHub Workflow and Composite action files and pin versions of Actions and Reusable Workflows.|
