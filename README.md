...
|-|-|-|
|[ccusage](https://github.com/ryoppippi/ccusage)|v15.10.0|A CLI tool for analyzing Claude Code usage from local JSONL files.|
|[claude-code](https://github.com/anthropics/claude-code)|v1.0.84|Agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster.|
...
|[gitlab-ci-ls](https://github.com/alesbrelih/gitlab-ci-ls)|v1.1.9|Language server for Gitlab CI.|
