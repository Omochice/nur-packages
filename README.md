...
|[claude-code](https://github.com/anthropics/claude-code)|v2.0.55|Agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster.|
...
|[gitlab-ci-verify](https://github.com/timo-reymann/gitlab-ci-verify)|v2.4.5|Validate and lint your gitlab ci files using ShellCheck, the Gitlab API, curated checks or even build your own checks .|
...
|[sort-package-json](https://github.com/keithamus/sort-package-json)|v3.5.0|Sort an Object or package.|
