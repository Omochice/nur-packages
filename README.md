...
1. Choose your CI: Depending on your preference you can use github actions (recommended) or [Travis ci](https://travis-ci.com).
...
1. Change your travis and cachix names on the README template section and delete
   the rest
