...
|[claude-code](https://github.com/anthropics/claude-code)|v2.1.81|Agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster.|
...
|[gh-dep](https://github.com/jackchuka/gh-dep)|v0.11.1|A GitHub CLI extension that streamlines the review and merge workflow for automated dependency update PRs.|
...
|[octocov](https://github.com/k1LoW/octocov)|v0.75.5|octocov is a toolkit for collecting code metrics (code coverage, code to test ratio, test execution time and your own custom metrics).|
