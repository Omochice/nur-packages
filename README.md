...
|[ccusage](https://github.com/ryoppippi/ccusage)|v18.0.9|A CLI tool for analyzing Claude Code usage from local JSONL files.|
|[claude-code](https://github.com/anthropics/claude-code)|v2.1.71|Agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster.|
...
|[gh-dep](https://github.com/jackchuka/gh-dep)|v0.10.2|A GitHub CLI extension that streamlines the review and merge workflow for automated dependency update PRs.|
...
|[lazygit](https://github.com/jesseduffield/lazygit)|v0.60.0|simple terminal UI for git commands.|
|[octocov](https://github.com/k1LoW/octocov)|v0.75.3|octocov is a toolkit for collecting code metrics (code coverage, code to test ratio, test execution time and your own custom metrics).|
