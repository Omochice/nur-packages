...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-wCkE/t06dpw732oZJ1NF6u1Asz2IcWdsqiAgr11EIR4=";
    };
  };
  claude-code = {
    pname = "claude-code";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-yPoNz2LmZp+PZa9bA7Tiv0ZcD1avTQduJ5luXxOAPhs=";
    };
  };
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.54.1";
      fetchSubmodules = false;
      sha256 = "sha256-MTuVeKlytI7jp3pi2nuJqebG7DcEprfNQo9jf+c7Obg=";
    };
  };
  octocov = {
    pname = "octocov";
