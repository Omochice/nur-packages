...
}:
{
  cc-sdd = {
    ...
    version = "3.1.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/cc-sdd/-/cc-sdd-3.1.0.tgz";
      sha256 = "sha256-4Ty4BzXH+y1yvbSn5NEwzmUGUUD7sTozcl4nkpUGypU=";
    };
  };
  ccusage = {
    pname = "ccusage";
  ...
  octocov = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.82.1";
      fetchSubmodules = false;
      sha256 = "sha256-i3UGD79j05isM8WoQUbyATfLklGQ8oE9XSKDPY9KWqA=";
    };
  };
  pinact = {
    pname = "pinact";
