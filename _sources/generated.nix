...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-cQGsEq6PAlimnHZfKS01TcOY2ZZKkkTm9nfX0kWoO2s=";
    };
  };
  claude-code = {
    pname = "claude-code";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ylYT34gNyY7JnXbYSh/DbEB2xb2A57zRLRGAH9PJ9Uc=";
    };
  };
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.54.0";
      fetchSubmodules = false;
      sha256 = "sha256-MOkqNbvrhbjcdNTNujy2gDsaLbl1eWeRWPx0KavHhas=";
    };
  };
  octocov = {
    pname = "octocov";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.68.2";
      fetchSubmodules = false;
      sha256 = "sha256-idlfCK/ZZsfcJacWLbDC4A58PKXUfBYQDYj+NLwme+I=";
    };
  };
  pinact = {
    pname = "pinact";
