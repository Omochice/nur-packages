...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-NoP1ha0mdHogTBN7aXYeIDenqd9PyAEAyjd4020i/ts=";
    };
  };
  claude-code = {
    pname = "claude-code";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Eits7Cw1TdkjoTITVHXVTYF4jwYBPG7l3WEQCxE08Bw=";
    };
  };
  ...
  gitlab-ci-ls = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.1.8";
      fetchSubmodules = false;
      sha256 = "sha256-8386MX5jR4LNrpuXVmv+aLnfEvzSJBZgggS3Uj2MU9A=";
    };
  };
  gitlab-ci-verify = {
  ...
  pinact = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.3.2";
      fetchSubmodules = false;
      sha256 = "sha256-epDtKwebVFCDZFwpOd2GWuY27EkD/xtkNE79XqTI9S0=";
    };
  };
  roots = {
    pname = "roots";
