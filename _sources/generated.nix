...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-PrrLbP61xRy5CmkEx3mYnXhH7Lc4gy8m30/mYG5rAzA=";
    };
  };
  claude-code = {
    pname = "claude-code";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-duEo4SIOzNTRXPkYaUzDVOeSTicyq0ZxgzLFYjoaunc=";
    };
  };
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.55.0";
      fetchSubmodules = false;
      sha256 = "sha256-gx9l7MHWQGnLsD+L+SM+KzBgU8RLtpZG+66pPyerZW4=";
    };
  };
  octocov = {
    pname = "octocov";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.71.3";
      fetchSubmodules = false;
      sha256 = "sha256-TM+udBkRkNrT/iPnCJ8PSSe7yHi/dn5mKmmN8CmaGb8=";
    };
  };
  pinact = {
    pname = "pinact";
