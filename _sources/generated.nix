...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-zzbpzrTr2vmJBYEF3yW8cRaOGLAcPNHtl6YxyDHVmE4=";
    };
  };
  claude-code = {
    pname = "claude-code";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-d/ylolW5WvGiI/ldFBGUGsbWu0Qc4ReEMPjvlVey8HI=";
    };
  };
  ...
  gitlab-ci-ls = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.2.0";
      fetchSubmodules = false;
      sha256 = "sha256-udfd1ehURvG+Zcek7Axjluhz4AM+5KTSme/vHKefMzs=";
    };
  };
  gitlab-ci-verify = {
  ...
  octocov = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.70.0";
      fetchSubmodules = false;
      sha256 = "sha256-SyJYJk7fc45D3CR098PbyvS+jmEjICAq9bdqukspwP8=";
    };
  };
  pinact = {
    pname = "pinact";
