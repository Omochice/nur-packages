...
}:
{
  ...
  ccusage = {
    ...
    version = "20.0.20";
    src = fetchurl {
      url = "https://registry.npmjs.org/ccusage/-/ccusage-20.0.20.tgz";
      sha256 = "sha256-3xmRuR9OWSpW29GVV+UTSEt0hjGPtuC5jUVpxwjrrtM=";
    };
  };
  claude-code = {
    pname = "claude-code";
  ...
  gitlab-ci-verify = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.11.4";
      fetchSubmodules = false;
      sha256 = "sha256-TjtsFKlScbfkCfq5RZ1L0P1QLrlGUTfqH4Y6XIif+lo=";
    };
  };
  godoclint = {
    pname = "godoclint";
