...
}:
{
  ...
  ccusage = {
    ...
    version = "20.0.6";
    src = fetchurl {
      url = "https://registry.npmjs.org/ccusage/-/ccusage-20.0.6.tgz";
      sha256 = "sha256-hXKQF7jUVz71/BKn++V7S+OC9uCuc0+6TYYZ5MKjGcM=";
    };
  };
  claude-code = {
    pname = "claude-code";
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.62.1";
      fetchSubmodules = false;
      sha256 = "sha256-JBSsLfng0W7uIbm6Jl/uDqYkl9cP+snbmDV9a83ZnR8=";
    };
  };
  octocov = {
    pname = "octocov";
