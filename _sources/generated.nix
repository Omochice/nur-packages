...
}:
{
  ...
  claude-code = {
    ...
    version = "2.1.26";
    src = fetchurl {
      url = "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-2.1.26.tgz";
      sha256 = "sha256-hpY0E5suHr1dZP+LXmQ1XD1H5Wz4pphinMIkXGq0scc=";
    };
  };
  ...
  git-wt = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.16.1";
      fetchSubmodules = false;
      sha256 = "sha256-hy9h9QY59h7mp0W2B4cRz8SQFtAGp+2puRtM6ojfKds=";
    };
  };
  gitlab-ci-ls = {
    pname = "gitlab-ci-ls";
