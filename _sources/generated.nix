...
}:
{
  ...
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-YlNliyF278xmc08ZZlwx0Ma4FIw/NtbXLsFdFocbVaQ=";
    };
  };
  claude-code = {
    pname = "claude-code";
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ptwJn0ma3NQPjMU/k8cJ/rDB0OYrqMe+LoC/DEcK3gc=";
    };
  };
  ...
  gh-dep = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.11.2";
      fetchSubmodules = false;
      sha256 = "sha256-bKBMaXkNWxdJV3t5ny/bSQBF8DcgNyKguQtoheHHP2E=";
    };
  };
  gh-grep = {
    pname = "gh-grep";
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.61.1";
      fetchSubmodules = false;
      sha256 = "sha256-sFmOHsYs39i4mSH/CnetWFBQBviv5QsP0qfCSkaEJZE=";
    };
  };
  octocov = {
    pname = "octocov";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.75.7";
      fetchSubmodules = false;
      sha256 = "sha256-2kn47nfE12L2ulMQWpsJlk2iN0TQm0BqeSE3GZEdHGQ=";
    };
  };
  pinact = {
    pname = "pinact";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.9.2";
      fetchSubmodules = false;
      sha256 = "sha256-wbonAugeAgN4drlndazoypQKH5vQNqmZj0Pbkmiygr0=";
    };
  };
  roots = {
    pname = "roots";
  ...
  salesforce-cli = {
    ...
    version = "2.133.4";
    src = fetchurl {
      url = "https://registry.npmjs.org/@salesforce/cli/-/cli-2.133.4.tgz";
      sha256 = "sha256-e0hO1SfCWab3lDX1w+wn2ibbvEu1xSYUKaWbp+7uZPA=";
    };
  };
  slack-reminder = {
