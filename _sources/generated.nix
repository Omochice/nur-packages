...
}:
{
  ...
  ccusage = {
    ...
    version = "20.0.14";
    src = fetchurl {
      url = "https://registry.npmjs.org/ccusage/-/ccusage-20.0.14.tgz";
      sha256 = "sha256-iCYB5ojBrhlH23EnunYMDceapSV6vhK4STdXdB6DuFE=";
    };
  };
  claude-code = {
    pname = "claude-code";
  ...
  zsp = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.4.11";
      fetchSubmodules = false;
      sha256 = "sha256-R9psX5uj6FJEdpwOWWXyzkwFZNsXxy/Y0X5u1/4vOQA=";
    };
  };
}
