...
}:
{
  ...
  ccusage = {
    ...
    version = "20.0.18";
    src = fetchurl {
      url = "https://registry.npmjs.org/ccusage/-/ccusage-20.0.18.tgz";
      sha256 = "sha256-d+iBC5JXStBo4Oo2y2CtOAN9z1G0by8+M753DT14NvU=";
    };
  };
  claude-code = {
    pname = "claude-code";
  ...
  gh-dep = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.11.4";
      fetchSubmodules = false;
      sha256 = "sha256-AQwrnDFfxXVkXLsVhGd0+0Ha68bwxkOPvgzl0VfWOtw=";
    };
  };
  gh-grep = {
    pname = "gh-grep";
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.63.1";
      fetchSubmodules = false;
      sha256 = "sha256-vcpd04DEHmtEJtOOYohxHUgNtQfiChErWmNiQle8pvc=";
    };
  };
  octocov = {
    pname = "octocov";
  ...
  salesforce-cli = {
    ...
    version = "2.144.6";
    src = fetchurl {
      url = "https://registry.npmjs.org/@salesforce/cli/-/cli-2.144.6.tgz";
      sha256 = "sha256-/ZTML6H42PveBbOzF6/QO/Z4WEd2Eo9xcgnt7ZJLcaA=";
    };
  };
  slack-reminder = {
