...
}:
{
  ...
  ccusage = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-c2xz9hXNMyRkbYCHTuf07vHuUdKtYvPaujtcPIY9t7g=";
    };
  };
  claude-code = {
    pname = "claude-code";
    version = "2.1.64";
    src = fetchurl {
      url = "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-2.1.64.tgz";
      sha256 = "sha256-Kpu5DHVTcK+AP/KbUDlxlPZGa2SEy/bRQOtr/BZ5n9g=";
    };
  };
  ...
  lazygit = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.59.0";
      fetchSubmodules = false;
      sha256 = "sha256-DVeWHkyZRzrp0Dl3xx5LMYdUhB94/Bp84mnquF6Fc3g=";
    };
  };
  octocov = {
    pname = "octocov";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.74.4";
      fetchSubmodules = false;
      sha256 = "sha256-45fxoYzvWKpdeum5Nk50Cm//HGdPmZzEc8IaVfgOfmo=";
    };
  };
  pinact = {
    pname = "pinact";
