...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gitlab-ci-verify = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.0.2";
      fetchSubmodules = false;
      sha256 = "sha256-ByuX7vh1zaUDfEymS6SxooLHmbxKz4KlIS5vQGG80jY=";
    };
  };
  octocov = {
    pname = "octocov";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.65.0";
      fetchSubmodules = false;
      sha256 = "sha256-E5OSng1vObisA3xPVmVPy8+bY5NoKFOQlPkLUUMhcVE=";
    };
  };
  pinact = {
    pname = "pinact";
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.0.0";
      fetchSubmodules = false;
      sha256 = "sha256-SkzqbliWsMLa0BsSqfKzHYk2z8PvsM+nssRihRyH1s4=";
    };
  };
  sort-package-json = {
